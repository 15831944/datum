...
//            if (split1.Count() > 2) return false;
            
//            string[] split2 = split1[1].Split('-');
//            if (split2.Count() > 2) return false; // CHECK 4

//            string numb = split1[0];
//            string diam = split2[0];
//            string pos = split2[1];

//            if (diam.Length == 0) return false; // CHECK 5
//            if (pos.Length < 2) return false; // CHECK 6
...
//                    if (currentNumber < 0) return false; // CHECK 7
...
//            if (temp == 0) return false; // CHECK 8
//            number = temp;
